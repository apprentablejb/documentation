      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : BrowseWidget(
                  restaurantRef: params.getParam<DocumentReference>(
                      'restaurantRef',
        ...
        FFRoute(
          ...
          builder: (context, params) => RestaurantDetailWidget(
        ...
        FFRoute(
          ...
          path: '/restaurantsInfo',
          builder: (context, params) => RestaurantsInfoWidget(
            restaurantRef: params.getParam('restaurantRef',
                ParamType.DocumentReference, false, ['restaurants']),
          ),
        ),
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ...
              : HomepageWidget(
                  categories: params.getParam<String>(
                      'categories', ParamType.String, true),
                ),
        ),
        FFRoute(
